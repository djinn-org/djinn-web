 ...
 **/
  var env = {
    ...
    scss:         __dirname + '/www/sass/style.scss',
    scsssources:  __dirname + '/www/sass/**/*.scss',
...
*
*******************************************************************************/
  gulp.task('default', ['scss', 'inject', 'connect', 'watches'], function() {
    return gutil.log('!=== App running on localhost:'+ env.port +' ===!');
  });

  // scss compile
  gulp.task('scss', function() {
    return gulp.src(env.scss)
 ...
 **/
  gulp.task('watches', function() {
    gulp.watch(env.scsssources, ['scss', 'inject', 'reload']);
